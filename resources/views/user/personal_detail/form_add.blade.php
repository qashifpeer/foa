            ...
            {{-- FIRST NAME --}}
                        <div class="form-group col-sm-6 flex-column d-flex py-2">
                             <label class="form-control-label ">First Name<span class="text-danger"> *</span></label>
                              <input type="text" value="{{ old('firstName') }}" id="firstName" name="firstName" placeholder="Enter your first name"  >
                            @error('firstName')
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex py-2">
                             ...
                             <input type="text" value="{{ old('middleName') }}" id="middleName" name="middleName" placeholder="Enter your middle name" >
                            @error('middleName')
                            <div class="text text-danger">{{ $message }}</div>
                            @enderror
                         </div>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                            <label class="form-control-label ">Last Name<span class="text-danger"> *</span></label>
                             <input type="text" value="{{ old('lastName') }}" id="lastName" name="lastName" placeholder="Enter your last name" required>
                             @error('lastName')
                            <div class="text text-danger">{{ $message }}</div>
                            @enderror
                         </div>
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                            ...
                            <input type="text" value="{{ old('fatherName') }}" id="fatherName" name="fatherName" placeholder="Enter your father's name" required>
                            @error('fatherName')
                            <div class="text text-danger">{{ $message }}</div>
                            @enderror
                         </div>
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2 ">
                            ...
                            <input type="text" value="{{ old('motherName') }}" id="motherName" name="motherName" placeholder="Enter your mother's name" required>
                            @error('motherName')
                            <div class="text text-danger">{{ $message }}</div>
                            @enderror
                         </div>
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                            ...
                            <input type="text" value="{{ old('guardianName') }}" id="guardianName" name="guardianName" placeholder="Enter your guardian name">
                            @error('guardianName')
                            <div class="text text-danger">{{ $message }}</div>
                            @enderror
                         </div>
                     ...
                     <div class="row justify-content-between text-left ">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                             ...
                             <input type="email" value="{{ old('emailPrimary') }}" id="emailPrimary" name="emailPrimary" placeholder="exampla@abc.com" required>
                            @error('emailPrimary')
                            <div class="text text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                            ...
                            <input type="email" value="{{ old('emailAlternate') }}" id="emailAlternate" name="emailAlternate" placeholder="exampla@abc.com" >
                    ...
                    <div class="row justify-content-between text-left">
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                            ...
                            <input type="number" value="{{ old('contactPrimary') }}" id="contactPrimary" name="contactPrimary" placeholder="9906600000" required>
                        ...
                        <div class="form-group col-sm-6 flex-column d-flex  py-2">
                            <label class="form-control-label ">Contact- Alternate<span class="text-danger"> </span></label>
                             <input type="number" value="{{ old('contactAlternate') }}" id="contactAlternate" name="contactAlternate" placeholder="9906600000" > </div>
                    </div>
