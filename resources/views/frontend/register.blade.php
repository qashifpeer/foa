...
<div class="container">
    <div class="row justify-content-center py-2">
        <div class="col-md-4">
            <div class="card mt-3" >
                <div class="card-header text-center bg-info"><strong>Registration Form</strong> </div>
                <div class="card-body">
                    ...
                    <div class="text-center mt-1">
                        <form method="POST" action="{{ route('register_submit') }}">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" class="form-control border border-success border-2" name="name" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class="mb-2">
                              ...
                              <input type="email" class="form-control border border-success border-2" name="email" value="{{ old('email') }}">
                              @error('email')
                              <div class="text text-danger">{{ $message }}</div>
                              @enderror
                            </div>
